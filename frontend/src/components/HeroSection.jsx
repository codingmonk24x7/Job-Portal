    ...
    return (
        <div className='text-center'>
            <div className='flex flex-col gap-5 my-10'>
                ...
                <div>
                    <p className='text-gray-500'>Unlock your potential and achieve your career aspirations.<br /> Our platform connects you with leading recruiters who are looking for talented individuals like you.</p>
                </div>
